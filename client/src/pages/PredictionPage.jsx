      ...
      <div className="max-w-[1600px] mx-auto">
        ...
        <div className="mt-10 pt-6 border-t border-white/10">
          ...
          <div className="flex items-center justify-center gap-6 mt-6">
            <a href="mailto:totaldu17@gmail.com" className="flex items-center gap-1.5 text-white/30 hover:text-white/60 transition-colors text-xs">
            ...
            <a href="https://x.com/down_up17" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 text-white/30 hover:text-white/60 transition-colors text-xs">
              <svg viewBox="0 0 24 24" fill="currentColor" width="14" height="14">
                <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
              </svg>
              down_up17
            </a>
            <a href="https://instagram.com/down17up" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 text-white/30 hover:text-white/60 transition-colors text-xs">
              <svg viewBox="0 0 24 24" fill="currentColor" width="14" height="14">
          ...
          <p className="text-white/20 text-[11px] mt-4 text-center">2026 TotalDU</p>
        </div>
      </div>
    </div>
  );
