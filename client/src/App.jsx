...
const PRIORITY_TIERS = [
  ...
  },
  {
    ...
    color: '#2563EB',
    bg: '#DBEAFE',
    moves: ['방어', '가로채기', '매직코트', '버티기', '킹실드', '니들가드', '토치카', '블로킹', '화염의수호', '판별', '스레드트랩'],
      ...
      <div className="min-h-screen bg-[#F9FAFB] flex flex-col font-sans">
        ...
        <footer className="mt-auto py-12 bg-white text-center border-t border-gray-100">
          <div className="flex items-center justify-center gap-6 mb-4">
            <a href="mailto:totaldu17@gmail.com" className="flex items-center gap-1.5 text-gray-400 hover:text-gray-600 transition-colors text-xs">
            ...
            <a href="https://x.com/down_up17" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 text-gray-400 hover:text-gray-600 transition-colors text-xs">
              <svg viewBox="0 0 24 24" fill="currentColor" width="14" height="14">
                <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
              </svg>
              down_up17
            </a>
            <a href="https://instagram.com/down17up" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 text-gray-400 hover:text-gray-600 transition-colors text-xs">
              <svg viewBox="0 0 24 24" fill="currentColor" width="14" height="14">
